...
import {Plus, Trash2, Code2, FileText, Lightbulb, BookOpen, CheckCircle2, Download, DollarSign, ListMusic, ChevronDown, Loader2, Calendar} from "lucide-react"
...
const CreateProblemForm = () => {
    ...
    const onSubmit = async (value) => {
        console.log("Form submitted with values:", value) // For debugging
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 pb-4 border-b border-gray-700">
                            ...
                            <div className="flex flex-col md:flex-row gap-3 mt-4 md:mt-0">
                                <div className="join bg-gray-700/50 rounded-lg overflow-hidden border border-gray-600">
                                    <button
                                        type="button"
                                        className={`join-item px-4 py-2 ${sampleType === "DP" ? "bg-gradient-to-r from-blue-500 to-purple-500 text-white" : "bg-transparent text-gray-300 hover:bg-gray-600/50"}`}
                                    ...
                                    <button
                                        type="button"
                                        className={`join-item px-4 py-2 ${sampleType === "string" ? "bg-gradient-to-r from-blue-500 to-purple-500 text-white" : "bg-transparent text-gray-300 hover:bg-gray-600/50"}`}
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="form-control flex flex-col">
                                    ...
                                    <label className="cursor-pointer label justify-start gap-3">
                                        <div className={`relative w-12 h-6 transition-all duration-300 rounded-full ${isPaid ? 'bg-gradient-to-r from-blue-500 to-purple-500' : 'bg-gray-600'}`}>
                                            <input
                                                type="checkbox"
                                                className="sr-only"
                                                {...register("isPaid")}
                                            ...
                                            />
                                            <div className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all duration-300 ${isPaid ? 'left-7' : 'left-1'}`}></div>
                                        </div>
                                ...
                                <div className="bg-gray-700/30 rounded-lg p-6 border border-gray-600 shadow-inner">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="form-control flex flex-col">
                                            ...
                                            <label className="cursor-pointer label justify-start gap-3">
                                                <div className={`relative w-12 h-6 transition-all duration-300 rounded-full ${createNewPlaylist ? 'bg-gradient-to-r from-blue-500 to-purple-500' : 'bg-gray-600'}`}>
                                                    <input
                                                        type="checkbox"
                                                        className="sr-only"
                                                    ...
                                                    />
                                                    <div className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all duration-300 ${createNewPlaylist ? 'left-7' : 'left-1'}`}></div>
                                                </div>
                                                <span className="label-text text-gray-300">
                            ...
                            <div className="bg-gray-700/30 rounded-lg p-6 border border-gray-600 shadow-inner">
                                ...
                                <div className="space-y-6">
                                    {testcaseFields.map((field, index) => (
                                        <div key={field.id} className="bg-gray-800/50 rounded-lg border border-gray-700">
                            ...
                            <div className="bg-gray-700/30 rounded-lg p-6 border border-gray-600 shadow-inner">
                                ...
                                <div className="space-y-6">
                                    <div className="form-control">
                                        <label className="label">
                                            <span className="label-text text-gray-300 font-medium">Constraints</span>
                                        </label>
                                        <textarea
                                            className="textarea bg-gray-700/50 border-gray-600 focus:border-purple-500 focus:ring-1 focus:ring-purple-500/30 min-h-24 w-full p-3 resize-y placeholder-gray-400"
