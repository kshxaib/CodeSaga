        ...
        <div className="lg:w-1/2 relative overflow-hidden p-8 flex items-center justify-center">
          ...
          <div className="relative z-10 max-w-2xl text-center lg:text-left">
            ...
            <p className="mt-5 text-lg text-gray-300 max-w-3xl">
              Start your coding journey with access to premium resources, community support, and expert guidance.
            </p>
            ...
            <div className="mt-10 hidden lg:block">
              <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
                ...
                <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
                  ...
                  <p className="mt-1 text-sm text-gray-400">Connect with developers worldwide</p>
                </div>
